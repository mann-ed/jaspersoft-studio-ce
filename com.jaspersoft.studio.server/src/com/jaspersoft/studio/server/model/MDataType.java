...
public class MDataType extends AMResource {
	...
	public static IIconDescriptor getIconDescriptor() {
		if (iconDescriptor == null)
			iconDescriptor = new ServerIconDescriptor("datatype"); //$NON-NLS-1$
	...
	public String getJRSUrl() throws UnsupportedEncodingException {
		return "flow.html?_flowId=dataTypeFlow&isEdit=true&resource="
