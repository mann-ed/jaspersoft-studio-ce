...
public class WSUser  implements java.io.Serializable {
    ...
    private com.jaspersoft.jasperserver.ws.authority.WSRole[] roles;
    ...
    public WSUser(
           ...
           com.jaspersoft.jasperserver.ws.authority.WSRole[] roles) {
     ...
     * @return roles
     */
    public com.jaspersoft.jasperserver.ws.authority.WSRole[] getRoles() {
        return roles;
    }
     ...
     * @param roles
     */
    public void setRoles(com.jaspersoft.jasperserver.ws.authority.WSRole[] roles) {
        this.roles = roles;
    }
