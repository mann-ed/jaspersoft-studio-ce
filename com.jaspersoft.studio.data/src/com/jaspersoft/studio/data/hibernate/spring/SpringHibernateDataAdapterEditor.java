...
public class SpringHibernateDataAdapterEditor implements DataAdapterEditor {
	...
	public void setDataAdapter(DataAdapterDescriptor dataAdapter) {
		if (dataAdapter instanceof SpringHibernateDataAdapterDescriptor) {
			composite.setDataAdapter((SpringHibernateDataAdapterDescriptor) dataAdapter);
		}
	}
 ...
 WizardPage wizardPage, JasperReportsContext jrContext) {
		if (composite == null) {
			composite = new SpringHibernateDataAdapterComposite(parent, style, jrContext);
		}
		return composite;
	}
