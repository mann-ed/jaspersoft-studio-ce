...
public class ExcelDataAdapterDescriptor extends DataAdapterDescriptor implements IFieldsProvider, IWizardDataEditorProvider {
	public static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

	@Override
	public DataAdapter getDataAdapter() {
		if (dataAdapter == null)
			dataAdapter = new ExcelDataAdapterImpl();
		return dataAdapter;
	}

	@Override
	public DataAdapterEditor getEditor() {
		return new ExcelDataAdapterEditor();
	}
	...
	private void getFieldProvider() {
		if (fprovider == null)
			fprovider = new ExcelFieldsProvider();
	}
