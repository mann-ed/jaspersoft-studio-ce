...
/**
 * Widget to provide an expression for a subreport element, it provide an additional button
...
public class SPSubreportExpression extends SPExpression {
	...
	private class WSubreportExpression extends WTextExpression{
		...
		public WSubreportExpression(Composite parent, int style, int linesNum) {
			super(parent, style, linesNum);
		}
		
		@Override
		protected void createButtonControl() {
			browseSubreportButton = new Button(this, SWT.FLAT);
			browseSubreportButton.setImage(JaspersoftStudioPlugin.getInstance().getImage("/icons/resources/folder-16.gif"));
			browseSubreportButton.addSelectionListener(new SelectionAdapter() {
				
				@Override
				public void widgetSelected(SelectionEvent e) {
					SubreportSelectionDialog isd = new SubreportSelectionDialog(UIUtils.getShell());
		...
		protected void configureWidgetsLayoutData(int showMode) {
			...
			if (showMode == LABEL_ON_LEFT) {
				...
				fd_textExpression.left = new FormAttachment(0);
				fd_textExpression.right = new FormAttachment(browseSubreportButton, -5);
				fd_textExpression.height = heightHint;
				textExpression.setLayoutData(fd_textExpression);
				...
				browseSubreportButton.setLayoutData(fd_btnBrowse);
	...
	public SPSubreportExpression(Composite parent, AbstractSection section, IPropertyDescriptor pDescriptor) {
		super(parent, section, pDescriptor);
	}
	
	@Override
	protected void createComponent(Composite parent) {
		expr = new WSubreportExpression(parent, SWT.NONE, 1);
