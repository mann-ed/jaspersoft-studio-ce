...
public class GroupArrangementSection extends AbstractSection {
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		parent = getWidgetFactory().createSection(parent, Messages.GroupArrangementSection_SectionTitle, false, 2);
		...
		gd = new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalSpan = 3;
		createWidget4Property(parent, JRDesignGroup.PROPERTY_REPRINT_HEADER_ON_EACH_COLUMN, false).getControl()
		.setLayoutData(gd);
	...
	protected void initializeProvidedProperties() {
		...
		addProvidedProperties(JRDesignGroup.PROPERTY_MIN_DETAILS_TO_START_FROM_TOP, Messages.MGroup_MinDetailsTSFTTitle);
		...
		addProvidedProperties(JRDesignGroup.PROPERTY_REPRINT_HEADER_ON_EACH_PAGE, Messages.MGroup_reprintHeaderEPTitle);
		addProvidedProperties(JRDesignGroup.PROPERTY_REPRINT_HEADER_ON_EACH_COLUMN, Messages.MGroup_ReprintHeaderECTitle);
		...
		addProvidedProperties(JRDesignGroup.PROPERTY_PREVENT_ORPHAN_FOOTER, Messages.MGroup_PreventOrphanFooterTitle);
	}
}
