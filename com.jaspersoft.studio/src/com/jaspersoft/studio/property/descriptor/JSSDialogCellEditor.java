...
public abstract class JSSDialogCellEditor extends CellEditor implements IRefreshableCellEditor {
	...
	/**
	 * True if the null return from the dialog is a valid value
	 */
	private boolean allowNullValue;
	
	/**
	 * Listens for 'focusLost' events and fires the 'apply' event as long as the focus wasn't lost because the dialog was
	 * opened.
	 */
    ...
    protected JSSDialogCellEditor(Composite parent, boolean allowNullValue) {
        this(parent, defaultStyle, allowNullValue);
    }
