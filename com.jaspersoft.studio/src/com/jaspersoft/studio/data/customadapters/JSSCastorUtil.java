 ...
 * use the {@link ClassLoader} of the current thread to resolve the mappings,
 * but istead the one of the passed {@link JasperReportsConfiguration}. Doing
 * this allow to serialize and deserialize data adapter that are imported as jr
 * in the project folder of a report
 */
public class JSSCastorUtil {
	...
	public Object read(InputStream is) {
		try {
			Unmarshaller unmarshaller = getReadXmlContext().createUnmarshaller();// FIXME initialization is not thread
																					// safe
