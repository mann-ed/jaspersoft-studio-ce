...
/*
 * /* The Class MTotalPages.
 */
public class MTotalPages extends MTextField {
	...
	/**
	 * Instantiates a new m total pages.
	 */
	public MTotalPages() {
		super();
	}
	 ...
	 *          the new index
	 */
	public MTotalPages(ANode parent, JRTextField jrStaticText, int newIndex) {
