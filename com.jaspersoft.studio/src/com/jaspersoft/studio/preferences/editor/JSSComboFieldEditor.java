...
public class JSSComboFieldEditor extends FieldEditor {
	 ...
	 *          the names (labels) and underlying values to populate the combo widget. These should be arranged as: {
	 *          {name1, value1}, {name2, value2}, ...}
	 * @param parent
	 *          the parent composite
	 */
	public JSSComboFieldEditor(String name, String labelText, String[][] entryNamesAndValues, Composite parent) {
		init(name, labelText);
