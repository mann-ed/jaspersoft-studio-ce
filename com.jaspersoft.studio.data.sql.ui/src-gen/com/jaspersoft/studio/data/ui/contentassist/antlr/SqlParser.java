		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFromTableJoinAccess().getAlternatives_2(), "rule__FromTableJoin__Alternatives_2");
					...
					put(grammarAccess.getRowValueAccess().getAlternatives(), "rule__RowValue__Alternatives");
					...
					put(grammarAccess.getExpressionGroupAccess().getIsnotAlternatives_1_0(), "rule__ExpressionGroup__IsnotAlternatives_1_0");
					...
					put(grammarAccess.getWindowingClauseAccess().getAlternatives_0(), "rule__WindowingClause__Alternatives_0");
					put(grammarAccess.getWindowingClauseAccess().getAlternatives_1(), "rule__WindowingClause__Alternatives_1");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getAlternatives_1(), "rule__WindowingClauseOperandFollowing__Alternatives_1");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getAlternatives_1_2_1(), "rule__WindowingClauseOperandFollowing__Alternatives_1_2_1");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getAlternatives_1(), "rule__WindowingClauseOperandPreceding__Alternatives_1");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getAlternatives_1_2_1(), "rule__WindowingClauseOperandPreceding__Alternatives_1_2_1");
					put(grammarAccess.getOrderByClauseAccess().getAlternatives_0(), "rule__OrderByClause__Alternatives_0");
					put(grammarAccess.getOrderByClauseArgAccess().getAlternatives_1(), "rule__OrderByClauseArg__Alternatives_1");
					put(grammarAccess.getOrderByClauseArgAccess().getAlternatives_2_1(), "rule__OrderByClauseArg__Alternatives_2_1");
					put(grammarAccess.getQueryPartitionClauseAccess().getAlternatives_2(), "rule__QueryPartitionClause__Alternatives_2");
					...
					put(grammarAccess.getScalarNumberOperandAccess().getAlternatives(), "rule__ScalarNumberOperand__Alternatives");
					put(grammarAccess.getSQLCASEAccess().getAlternatives_1(), "rule__SQLCASE__Alternatives_1");
					put(grammarAccess.getSqlCaseWhenAccess().getAlternatives_1(), "rule__SqlCaseWhen__Alternatives_1");
					...
					put(grammarAccess.getSelectAccess().getGroup_2_3(), "rule__Select__Group_2_3__0");
					...
					put(grammarAccess.getSelectAccess().getGroup_11(), "rule__Select__Group_11__0");
					put(grammarAccess.getSelectAccess().getGroup_12(), "rule__Select__Group_12__0");
					...
					put(grammarAccess.getFromTableJoinAccess().getGroup_2_0(), "rule__FromTableJoin__Group_2_0__0");
					put(grammarAccess.getJoinConditionAccess().getGroup(), "rule__JoinCondition__Group__0");
					put(grammarAccess.getUsingColsAccess().getGroup(), "rule__UsingCols__Group__0");
					put(grammarAccess.getUsingColsAccess().getGroup_1(), "rule__UsingCols__Group_1__0");
					put(grammarAccess.getUsingColsAccess().getGroup_1_1(), "rule__UsingCols__Group_1_1__0");
					put(grammarAccess.getTableOrAliasAccess().getGroup(), "rule__TableOrAlias__Group__0");
					put(grammarAccess.getFromValuesAccess().getGroup(), "rule__FromValues__Group__0");
					put(grammarAccess.getFromValuesColumnsAccess().getGroup(), "rule__FromValuesColumns__Group__0");
					put(grammarAccess.getFromValuesColumnNamesAccess().getGroup(), "rule__FromValuesColumnNames__Group__0");
					put(grammarAccess.getFromValuesColumnNamesAccess().getGroup_1(), "rule__FromValuesColumnNames__Group_1__0");
					put(grammarAccess.getFromValuesColumnNamesAccess().getGroup_1_1(), "rule__FromValuesColumnNames__Group_1_1__0");
					put(grammarAccess.getValuesAccess().getGroup(), "rule__Values__Group__0");
					put(grammarAccess.getRowsAccess().getGroup(), "rule__Rows__Group__0");
					put(grammarAccess.getRowsAccess().getGroup_1(), "rule__Rows__Group_1__0");
					put(grammarAccess.getRowsAccess().getGroup_1_1(), "rule__Rows__Group_1_1__0");
					put(grammarAccess.getRowAccess().getGroup(), "rule__Row__Group__0");
					put(grammarAccess.getRowValuesAccess().getGroup(), "rule__RowValues__Group__0");
					put(grammarAccess.getRowValuesAccess().getGroup_1(), "rule__RowValues__Group_1__0");
					put(grammarAccess.getRowValuesAccess().getGroup_1_1(), "rule__RowValues__Group_1_1__0");
					...
					put(grammarAccess.getUnpivotInClauseArgsAccess().getGroup(), "rule__UnpivotInClauseArgs__Group__0");
					put(grammarAccess.getUnpivotInClauseArgsAccess().getGroup_1(), "rule__UnpivotInClauseArgs__Group_1__0");
					put(grammarAccess.getUnpivotInClauseArgsAccess().getGroup_1_1(), "rule__UnpivotInClauseArgs__Group_1_1__0");
					put(grammarAccess.getUnpivotInClauseArgAccess().getGroup(), "rule__UnpivotInClauseArg__Group__0");
					put(grammarAccess.getUnpivotInClauseArgAccess().getGroup_1(), "rule__UnpivotInClauseArg__Group_1__0");
					put(grammarAccess.getPivotForClauseAccess().getGroup(), "rule__PivotForClause__Group__0");
					put(grammarAccess.getPivotForClauseAccess().getGroup_1_1(), "rule__PivotForClause__Group_1_1__0");
					put(grammarAccess.getPivotColumnsAccess().getGroup_1(), "rule__PivotColumns__Group_1__0");
					put(grammarAccess.getPivotColsAccess().getGroup(), "rule__PivotCols__Group__0");
					put(grammarAccess.getPivotColsAccess().getGroup_1(), "rule__PivotCols__Group_1__0");
					put(grammarAccess.getPivotColsAccess().getGroup_1_1(), "rule__PivotCols__Group_1_1__0");
					put(grammarAccess.getPivotColAccess().getGroup(), "rule__PivotCol__Group__0");
					put(grammarAccess.getPivotColAccess().getGroup_1(), "rule__PivotCol__Group_1__0");
					put(grammarAccess.getPivotColAccess().getGroup_1_1(), "rule__PivotCol__Group_1_1__0");
					...
					put(grammarAccess.getXExpression_Access().getGroup_5(), "rule__XExpression___Group_5__0");
					...
					put(grammarAccess.getIsNullValueAccess().getGroup(), "rule__IsNullValue__Group__0");
					put(grammarAccess.getComparisonAccess().getGroup(), "rule__Comparison__Group__0");
					put(grammarAccess.getLikeAccess().getGroup(), "rule__Like__Group__0");
					put(grammarAccess.getLikeValueAccess().getGroup(), "rule__LikeValue__Group__0");
					put(grammarAccess.getBetweenAccess().getGroup(), "rule__Between__Group__0");
					put(grammarAccess.getBetweenValueAccess().getGroup(), "rule__BetweenValue__Group__0");
					put(grammarAccess.getInOperatorAccess().getGroup(), "rule__InOperator__Group__0");
					put(grammarAccess.getInValueAccess().getGroup(), "rule__InValue__Group__0");
					put(grammarAccess.getExistsOperatorAccess().getGroup(), "rule__ExistsOperator__Group__0");
					put(grammarAccess.getExistsValueAccess().getGroup(), "rule__ExistsValue__Group__0");
					put(grammarAccess.getOperandListGroupAccess().getGroup(), "rule__OperandListGroup__Group__0");
					...
					put(grammarAccess.getFunctionExtractAccess().getGroup(), "rule__FunctionExtract__Group__0");
					put(grammarAccess.getFunctionAnalyticalAccess().getGroup(), "rule__FunctionAnalytical__Group__0");
					put(grammarAccess.getAnalyticClauseAccess().getGroup(), "rule__AnalyticClause__Group__0");
					put(grammarAccess.getAnalyticClauseAccess().getGroup_2(), "rule__AnalyticClause__Group_2__0");
					put(grammarAccess.getWindowingClauseAccess().getGroup(), "rule__WindowingClause__Group__0");
					put(grammarAccess.getWindowingClauseBetweenAccess().getGroup(), "rule__WindowingClauseBetween__Group__0");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getGroup(), "rule__WindowingClauseOperandFollowing__Group__0");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getGroup_1_0(), "rule__WindowingClauseOperandFollowing__Group_1_0__0");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getGroup_1_1(), "rule__WindowingClauseOperandFollowing__Group_1_1__0");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getGroup_1_2(), "rule__WindowingClauseOperandFollowing__Group_1_2__0");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getGroup(), "rule__WindowingClauseOperandPreceding__Group__0");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getGroup_1_0(), "rule__WindowingClauseOperandPreceding__Group_1_0__0");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getGroup_1_1(), "rule__WindowingClauseOperandPreceding__Group_1_1__0");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getGroup_1_2(), "rule__WindowingClauseOperandPreceding__Group_1_2__0");
					put(grammarAccess.getOrderByClauseAccess().getGroup(), "rule__OrderByClause__Group__0");
					put(grammarAccess.getOrderByClauseAccess().getGroup_0_0(), "rule__OrderByClause__Group_0_0__0");
					put(grammarAccess.getOrderByClauseAccess().getGroup_0_1(), "rule__OrderByClause__Group_0_1__0");
					put(grammarAccess.getOrderByClauseArgsAccess().getGroup(), "rule__OrderByClauseArgs__Group__0");
					put(grammarAccess.getOrderByClauseArgsAccess().getGroup_1(), "rule__OrderByClauseArgs__Group_1__0");
					put(grammarAccess.getOrderByClauseArgsAccess().getGroup_1_1(), "rule__OrderByClauseArgs__Group_1_1__0");
					put(grammarAccess.getOrderByClauseArgAccess().getGroup(), "rule__OrderByClauseArg__Group__0");
					put(grammarAccess.getOrderByClauseArgAccess().getGroup_2(), "rule__OrderByClauseArg__Group_2__0");
					put(grammarAccess.getQueryPartitionClauseAccess().getGroup(), "rule__QueryPartitionClause__Group__0");
					put(grammarAccess.getQueryPartitionClauseAccess().getGroup_2_1(), "rule__QueryPartitionClause__Group_2_1__0");
					put(grammarAccess.getAnalyticExprArgsAccess().getGroup(), "rule__AnalyticExprArgs__Group__0");
					put(grammarAccess.getAnalyticExprArgsAccess().getGroup_1(), "rule__AnalyticExprArgs__Group_1__0");
					put(grammarAccess.getAnalyticExprArgsAccess().getGroup_1_1(), "rule__AnalyticExprArgs__Group_1_1__0");
					put(grammarAccess.getAnalyticExprArgAccess().getGroup(), "rule__AnalyticExprArg__Group__0");
					...
					put(grammarAccess.getColumnOperandAccess().getGroup(), "rule__ColumnOperand__Group__0");
					...
					put(grammarAccess.getModelAccess().getWqAssignment_1(), "rule__Model__WqAssignment_1");
					put(grammarAccess.getModelAccess().getQueryAssignment_2(), "rule__Model__QueryAssignment_2");
					put(grammarAccess.getWithQueryAccess().getWAssignment_0(), "rule__WithQuery__WAssignment_0");
					...
					put(grammarAccess.getSelectAccess().getGroupByEntryAssignment_7_2(), "rule__Select__GroupByEntryAssignment_7_2");
					put(grammarAccess.getSelectAccess().getHavingEntryAssignment_8_1(), "rule__Select__HavingEntryAssignment_8_1");
					put(grammarAccess.getSelectAccess().getOrderByEntryAssignment_9_2(), "rule__Select__OrderByEntryAssignment_9_2");
					put(grammarAccess.getSelectAccess().getLimAssignment_10_1(), "rule__Select__LimAssignment_10_1");
					put(grammarAccess.getSelectAccess().getOffsetAssignment_11_1(), "rule__Select__OffsetAssignment_11_1");
					put(grammarAccess.getSelectAccess().getFetchFirstAssignment_12_2(), "rule__Select__FetchFirstAssignment_12_2");
					...
					put(grammarAccess.getFromTableJoinAccess().getJoinExprAssignment_2_0_1(), "rule__FromTableJoin__JoinExprAssignment_2_0_1");
					put(grammarAccess.getFromTableJoinAccess().getJoinCondAssignment_2_1(), "rule__FromTableJoin__JoinCondAssignment_2_1");
					put(grammarAccess.getJoinConditionAccess().getUseColsAssignment_2(), "rule__JoinCondition__UseColsAssignment_2");
					put(grammarAccess.getUsingColsAccess().getEntriesAssignment_1_1_1(), "rule__UsingCols__EntriesAssignment_1_1_1");
					...
					put(grammarAccess.getTableOrAliasAccess().getValuesAssignment_0_2(), "rule__TableOrAlias__ValuesAssignment_0_2");
					put(grammarAccess.getTableOrAliasAccess().getPivotAssignment_1_0(), "rule__TableOrAlias__PivotAssignment_1_0");
					...
					put(grammarAccess.getFromValuesAccess().getValuesAssignment_0(), "rule__FromValues__ValuesAssignment_0");
					put(grammarAccess.getFromValuesAccess().getCAssignment_1(), "rule__FromValues__CAssignment_1");
					put(grammarAccess.getFromValuesColumnsAccess().getFvColsAssignment_2(), "rule__FromValuesColumns__FvColsAssignment_2");
					put(grammarAccess.getFromValuesColumnNamesAccess().getEntriesAssignment_1_1_1(), "rule__FromValuesColumnNames__EntriesAssignment_1_1_1");
					put(grammarAccess.getColumnNameAccess().getColNameAssignment(), "rule__ColumnName__ColNameAssignment");
					put(grammarAccess.getValuesAccess().getRowsAssignment_2(), "rule__Values__RowsAssignment_2");
					put(grammarAccess.getRowsAccess().getEntriesAssignment_1_1_1(), "rule__Rows__EntriesAssignment_1_1_1");
					put(grammarAccess.getRowAccess().getRowValuesAssignment_1(), "rule__Row__RowValuesAssignment_1");
					put(grammarAccess.getRowValuesAccess().getEntriesAssignment_1_1_1(), "rule__RowValues__EntriesAssignment_1_1_1");
					put(grammarAccess.getRowValueAccess().getNullAssignment_1(), "rule__RowValue__NullAssignment_1");
					...
					put(grammarAccess.getUnpivotInClauseAccess().getOpAssignment_1(), "rule__UnpivotInClause__OpAssignment_1");
					put(grammarAccess.getUnpivotInClauseAccess().getArgsAssignment_3(), "rule__UnpivotInClause__ArgsAssignment_3");
					put(grammarAccess.getUnpivotInClauseArgsAccess().getEntriesAssignment_1_1_1(), "rule__UnpivotInClauseArgs__EntriesAssignment_1_1_1");
					put(grammarAccess.getUnpivotInClauseArgAccess().getPcolsAssignment_0(), "rule__UnpivotInClauseArg__PcolsAssignment_0");
					put(grammarAccess.getUnpivotInClauseArgAccess().getCfulsAssignment_1_1(), "rule__UnpivotInClauseArg__CfulsAssignment_1_1");
					put(grammarAccess.getPivotColsAccess().getEntriesAssignment_1_1_1(), "rule__PivotCols__EntriesAssignment_1_1_1");
					put(grammarAccess.getPivotColAccess().getEntriesAssignment_1_1_1(), "rule__PivotCol__EntriesAssignment_1_1_1");
					...
					put(grammarAccess.getExpressionFragmentAccess().getInAssignment_4(), "rule__ExpressionFragment__InAssignment_4");
					put(grammarAccess.getExpressionFragmentAccess().getExistsAssignment_5(), "rule__ExpressionFragment__ExistsAssignment_5");
					put(grammarAccess.getExpressionGroupAccess().getIsnotAssignment_1(), "rule__ExpressionGroup__IsnotAssignment_1");
					put(grammarAccess.getExpressionGroupAccess().getExprAssignment_3(), "rule__ExpressionGroup__ExprAssignment_3");
					put(grammarAccess.getXExpressionAccess().getXfAssignment_2(), "rule__XExpression__XfAssignment_2");
					put(grammarAccess.getXExpressionAccess().getColAssignment_4(), "rule__XExpression__ColAssignment_4");
					put(grammarAccess.getXExpressionAccess().getPrmAssignment_5_1(), "rule__XExpression__PrmAssignment_5_1");
					put(grammarAccess.getXExpression_Access().getXfAssignment_2(), "rule__XExpression___XfAssignment_2");
					put(grammarAccess.getXExpression_Access().getColAssignment_4(), "rule__XExpression___ColAssignment_4");
					put(grammarAccess.getXExpression_Access().getPrmAssignment_5_1(), "rule__XExpression___PrmAssignment_5_1");
					...
					put(grammarAccess.getExpressionAccess().getExistsAssignment_1_2(), "rule__Expression__ExistsAssignment_1_2");
					put(grammarAccess.getExpressionAccess().getBetweenAssignment_1_3(), "rule__Expression__BetweenAssignment_1_3");
					put(grammarAccess.getExpressionAccess().getLikeAssignment_1_4(), "rule__Expression__LikeAssignment_1_4");
					put(grammarAccess.getExpressionAccess().getCompAssignment_1_5(), "rule__Expression__CompAssignment_1_5");
					...
					put(grammarAccess.getInOperatorAccess().getOpListAssignment_2_1(), "rule__InOperator__OpListAssignment_2_1");
					put(grammarAccess.getExistsOperatorAccess().getOpAssignment_1(), "rule__ExistsOperator__OpAssignment_1");
					put(grammarAccess.getExistsOperatorAccess().getSubqueryAssignment_2_0(), "rule__ExistsOperator__SubqueryAssignment_2_0");
					put(grammarAccess.getExistsOperatorAccess().getOpListAssignment_2_1(), "rule__ExistsOperator__OpListAssignment_2_1");
					put(grammarAccess.getOperandListGroupAccess().getOpGroupAssignment_1(), "rule__OperandListGroup__OpGroupAssignment_1");
					...
					put(grammarAccess.getOperandFragmentAccess().getFextAssignment_4(), "rule__OperandFragment__FextAssignment_4");
					...
					put(grammarAccess.getFunctionExtractAccess().getOperandAssignment_4(), "rule__FunctionExtract__OperandAssignment_4");
					put(grammarAccess.getFunctionAnalyticalAccess().getAnClauseAssignment_2(), "rule__FunctionAnalytical__AnClauseAssignment_2");
					put(grammarAccess.getAnalyticClauseAccess().getAbcAssignment_1(), "rule__AnalyticClause__AbcAssignment_1");
					put(grammarAccess.getAnalyticClauseAccess().getObcAssignment_2_0(), "rule__AnalyticClause__ObcAssignment_2_0");
					put(grammarAccess.getAnalyticClauseAccess().getWincAssignment_2_1(), "rule__AnalyticClause__WincAssignment_2_1");
					put(grammarAccess.getWindowingClauseBetweenAccess().getWcoPAssignment_1(), "rule__WindowingClauseBetween__WcoPAssignment_1");
					put(grammarAccess.getWindowingClauseBetweenAccess().getWcoFAssignment_3(), "rule__WindowingClauseBetween__WcoFAssignment_3");
					put(grammarAccess.getWindowingClauseOperandFollowingAccess().getExpAssignment_1_2_0(), "rule__WindowingClauseOperandFollowing__ExpAssignment_1_2_0");
					put(grammarAccess.getWindowingClauseOperandPrecedingAccess().getExprAssignment_1_2_0(), "rule__WindowingClauseOperandPreceding__ExprAssignment_1_2_0");
					put(grammarAccess.getOrderByClauseAccess().getArgsAssignment_1(), "rule__OrderByClause__ArgsAssignment_1");
					put(grammarAccess.getOrderByClauseArgsAccess().getEntriesAssignment_1_1_1(), "rule__OrderByClauseArgs__EntriesAssignment_1_1_1");
					put(grammarAccess.getOrderByClauseArgAccess().getColAssignment_0(), "rule__OrderByClauseArg__ColAssignment_0");
					put(grammarAccess.getQueryPartitionClauseAccess().getArgsAssignment_2_0(), "rule__QueryPartitionClause__ArgsAssignment_2_0");
					put(grammarAccess.getAnalyticExprArgsAccess().getEntriesAssignment_1_1_1(), "rule__AnalyticExprArgs__EntriesAssignment_1_1_1");
					put(grammarAccess.getAnalyticExprArgAccess().getCeAssignment_0(), "rule__AnalyticExprArg__CeAssignment_0");
					put(grammarAccess.getAnalyticExprArgAccess().getColAliasAssignment_1(), "rule__AnalyticExprArg__ColAliasAssignment_1");
					...
					put(grammarAccess.getColumnOperandAccess().getCfullAssignment_0(), "rule__ColumnOperand__CfullAssignment_0");
					put(grammarAccess.getColumnOperandAccess().getOraAssignment_1(), "rule__ColumnOperand__OraAssignment_1");
					put(grammarAccess.getSubQueryOperandAccess().getSelAssignment_2(), "rule__SubQueryOperand__SelAssignment_2");
					put(grammarAccess.getScalarOperandAccess().getSostrAssignment_0(), "rule__ScalarOperand__SostrAssignment_0");
					put(grammarAccess.getScalarOperandAccess().getSodblAssignment_1(), "rule__ScalarOperand__SodblAssignment_1");
					put(grammarAccess.getScalarOperandAccess().getSodateAssignment_2(), "rule__ScalarOperand__SodateAssignment_2");
					put(grammarAccess.getScalarOperandAccess().getSotimeAssignment_3(), "rule__ScalarOperand__SotimeAssignment_3");
					put(grammarAccess.getScalarOperandAccess().getSodtAssignment_4(), "rule__ScalarOperand__SodtAssignment_4");
					put(grammarAccess.getScalarNumberOperandAccess().getSoUIntAssignment_0(), "rule__ScalarNumberOperand__SoUIntAssignment_0");
					put(grammarAccess.getScalarNumberOperandAccess().getSointAssignment_1(), "rule__ScalarNumberOperand__SointAssignment_1");
					put(grammarAccess.getScalarNumberOperandAccess().getSodblAssignment_2(), "rule__ScalarNumberOperand__SodblAssignment_2");
					put(grammarAccess.getScalarNumberOperandAccess().getSostrAssignment_3(), "rule__ScalarNumberOperand__SostrAssignment_3");
					put(grammarAccess.getSQLCASEAccess().getWopAssignment_1_0(), "rule__SQLCASE__WopAssignment_1_0");
					put(grammarAccess.getSQLCASEAccess().getExprAssignment_1_1(), "rule__SQLCASE__ExprAssignment_1_1");
					...
					put(grammarAccess.getSqlCaseWhenAccess().getWopAssignment_1_0(), "rule__SqlCaseWhen__WopAssignment_1_0");
					put(grammarAccess.getSqlCaseWhenAccess().getExprAssignment_1_1(), "rule__SqlCaseWhen__ExprAssignment_1_1");
