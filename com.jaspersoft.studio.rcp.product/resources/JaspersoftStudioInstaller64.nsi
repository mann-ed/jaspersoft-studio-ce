...
!define PRODUCT_PUBLISHER "Cloud Software Group, Inc."
...
!define ICONS_GROUP "Jaspersoft\${SHORT_PRODUCT_NAME} ${PRODUCT_VERSION} ${PRODUCT_ARCH}"
...
!define MUI_FINISHPAGE_TITLE "Completing the Jaspersoft Studio Setup Wizard"
!define MUI_FINISHPAGE_RUN_TEXT "Run Jaspersoft Studio"
...
InstallDir "$PROGRAMFILES64\Jaspersoft\${SHORT_PRODUCT_NAME}-${PRODUCT_VERSION}"
