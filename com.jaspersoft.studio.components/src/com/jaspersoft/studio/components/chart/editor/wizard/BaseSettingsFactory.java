...
public class BaseSettingsFactory {
	...
	public static final ChartThemeSettings createChartThemeSettings() {
		...
		chartSettings
				.setBackgroundImage(new FileImageProvider("net/sf/jasperreports/chartthemes/simple/jasperreports.png"));
		...
		legendSettings.getFont().setFontSize(7f);
		...
		domainAxisSettings.getLabelFont().setFontSize(10f);
		...
		domainAxisSettings.getTickLabelFont().setFontSize(7f);
		...
		rangeAxisSettings.getLabelFont().setFontSize(10f);
		...
		rangeAxisSettings.getTickLabelFont().setFontSize(7f);
