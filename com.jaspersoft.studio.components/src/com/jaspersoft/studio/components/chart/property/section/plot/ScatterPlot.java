...
public class ScatterPlot extends AbstractRealValueSection {

	@Override
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		super.createControls(parent, tabbedPropertySheetPage);
		createWidget4Property(parent, JRDesignScatterPlot.PROPERTY_SHOW_LINES);
		createWidget4Property(parent, JRDesignScatterPlot.PROPERTY_SHOW_SHAPES);
	...
	private void createCategory(Composite parent,
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_FONT, false)
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
	...
	private void createValue(Composite parent,
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
