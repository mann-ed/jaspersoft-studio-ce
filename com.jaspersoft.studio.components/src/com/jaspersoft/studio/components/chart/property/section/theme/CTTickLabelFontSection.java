...
public class CTTickLabelFontSection extends FontSection {
	@Override
	protected APropertyNode getModelFromEditPart(Object item) {
		APropertyNode md = super.getModelFromEditPart(item);
		if (md instanceof MPlotSettings)
			return (APropertyNode) md.getPropertyValue(PlotSettings.PROPERTY_tickLabelFont);
	...
	protected Composite createFontSection(Composite parent) {
		return getWidgetFactory().createSection(parent, "Tick Label Font", true, 4);
	}
}
