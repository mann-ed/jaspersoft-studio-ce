...
public class LinePlot extends AbstractRealValueSection {

	@Override
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		super.createControls(parent, tabbedPropertySheetPage);
		createWidget4Property(parent,JRDesignLinePlot.PROPERTY_SHOW_LINES);
		createWidget4Property(parent,JRDesignLinePlot.PROPERTY_SHOW_SHAPES);
	...
	private void createCategory(Composite parent,
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_LABEL_FONT, false)
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
	...
	private void createValue(Composite parent,
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignLinePlot.PROPERTY_VALUE_AXIS_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
		...
		gd.horizontalSpan = 2;
		createWidget4Property(group,
				JRDesignLinePlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, false)
				.getControl().setLayoutData(gd);
