...
public class MThermometerPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc) {
		...
		positionTypeD = new NamedEnumPropertyDescriptor<ValueLocationEnum>(
				JRDesignThermometerPlot.PROPERTY_VALUE_LOCATION,
				Messages.MThermometerPlot_value_location,
				ValueLocationEnum.BULB, NullEnum.NOTNULL);
		positionTypeD
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(JRDesignThermometerPlot.PROPERTY_VALUE_LOCATION))
			return positionTypeD.getIntValue(jrElement.getValueLocationValue());
	...
	private static NamedEnumPropertyDescriptor<ValueLocationEnum> positionTypeD;
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignThermometerPlot.PROPERTY_MERCURY_COLOR) && (value == null || value instanceof AlfaRGB))
			...
			jrElement.setValueLocation(positionTypeD.getEnumValue(value));
