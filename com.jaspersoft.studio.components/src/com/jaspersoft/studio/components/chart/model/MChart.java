...
public class MChart extends MGraphicElementLineBox
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc) {
		...
		titlePositionD.setHelpRefBuilder(new HelpReferenceBuilder(
				"net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#chartTitle_position"));
		desc.add(titlePositionD);

		evaluationTimeD = new NamedEnumPropertyDescriptor<EvaluationTimeEnum>(JRDesignChart.PROPERTY_EVALUATION_TIME,
				Messages.MChart_evaluation_time, EvaluationTimeEnum.AUTO, NullEnum.NOTNULL);
		...
		RWComboBoxPropertyDescriptor rendererTypeD = new RWComboBoxPropertyDescriptor(JRBaseChart.PROPERTY_RENDER_TYPE,
				Messages.MChart_renderer_type, new String[] { "", "draw", "image", "svg" }, NullEnum.NULL); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
																											// //$NON-NLS-5$
		...
		desc.add(titleFontD);
		titleFontD.setHelpRefBuilder(
				new HelpReferenceBuilder("net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#font"));
		...
		desc.add(titleExprD);
		titleExprD.setHelpRefBuilder(
				new HelpReferenceBuilder("net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#titleExpression"));
		...
		subtitleFontD.setHelpRefBuilder(
				new HelpReferenceBuilder("net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#font"));
		...
		subtitleExprD.setHelpRefBuilder(new HelpReferenceBuilder(
		...
		JRExpressionPropertyDescriptor anchorNameExp = new JRExpressionPropertyDescriptor(
				JRDesignChart.PROPERTY_ANCHOR_NAME_EXPRESSION,
				com.jaspersoft.studio.messages.Messages.MTextField_anchorNameLabel);
		anchorNameExp.setHelpRefBuilder(new HelpReferenceBuilder(
				"http://127.0.0.1:55429/help/topic/net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#anchorNameExpression")); //$NON-NLS-1$
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(JRBaseChart.PROPERTY_LEGEND_POSITION))
			return legendPositionD.getIntValue(jrElement.getLegendPositionValue());
