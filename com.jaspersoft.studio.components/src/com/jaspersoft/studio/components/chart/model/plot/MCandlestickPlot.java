...
public class MCandlestickPlot extends MChartPlot {
	...
	protected Map<String, DefaultValue> createDefaultsMap() {
		...
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
		defaultsMap.put(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR, new DefaultValue(AlfaRGB.getFullyOpaque(new RGB(0, 0, 0)), true));
	...
	public void setPropertyValue(Object id, Object value) {
		...
		} else if (id.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR) && (value == null || value instanceof AlfaRGB))
			jrElement.setTimeAxisLabelColor(Colors.getAWT4SWTRGBColor((AlfaRGB) value));
		else if (id.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_COLOR) && (value == null || value instanceof AlfaRGB))
			jrElement.setTimeAxisTickLabelColor(Colors.getAWT4SWTRGBColor((AlfaRGB) value));
		else if (id.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR) && (value == null || value instanceof AlfaRGB))
			jrElement.setTimeAxisLineColor(Colors.getAWT4SWTRGBColor((AlfaRGB) value));
		else if (id.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR) && (value == null || value instanceof AlfaRGB))
			jrElement.setValueAxisLabelColor(Colors.getAWT4SWTRGBColor((AlfaRGB) value));
		else if (id.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR) && (value == null || value instanceof AlfaRGB))
			jrElement.setValueAxisTickLabelColor(Colors.getAWT4SWTRGBColor((AlfaRGB) value));
		else if (id.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR) && (value == null || value instanceof AlfaRGB))
