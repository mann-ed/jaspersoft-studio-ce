...
public class MMeterPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc) {
		...
		shapeD = new NamedEnumPropertyDescriptor<MeterShapeEnum>(
				JRDesignMeterPlot.PROPERTY_SHAPE, Messages.MMeterPlot_shape,
				MeterShapeEnum.CHORD, NullEnum.NOTNULL);
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(JRDesignMeterPlot.PROPERTY_SHAPE))
			return shapeD.getIntValue(jrElement.getShapeValue());
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignMeterPlot.PROPERTY_INTERVALS)) {
			...
			try {
				jrElement.setShape(shapeD.getEnumValue(value));
			} catch (JRException e) {
				e.printStackTrace();
			}
