...
public class MBubblePlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc) {
		...
		catAxisVertTickLabelD
				.setHelpRefBuilder(new HelpReferenceBuilder(
						"net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#axisFormat_verticalTickLabels"));
		...
		catAxisTickLabelMaskD
				.setHelpRefBuilder(new HelpReferenceBuilder(
						"net.sf.jasperreports.doc/docs/schema.reference.html?cp=0_1#axisFormat_tickLabelMask"));
		...
		scaleType = new NamedEnumPropertyDescriptor<ScaleTypeEnum>(
				JRDesignBubblePlot.PROPERTY_SCALE_TYPE,
				Messages.MBubblePlot_scale_type, ScaleTypeEnum.ON_BOTH_AXES,
				NullEnum.NOTNULL);
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(JRDesignBubblePlot.PROPERTY_SCALE_TYPE))
			return scaleType.getIntValue(jrElement.getScaleTypeValue());
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignBubblePlot.PROPERTY_X_AXIS_LABEL_FONT)) {
			...
			jrElement.setScaleType((ScaleTypeEnum) scaleType
					.getEnumValue(value));
