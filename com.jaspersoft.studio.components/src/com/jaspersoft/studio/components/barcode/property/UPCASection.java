...
public class UPCASection extends AbstractSection {
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		Composite group = getWidgetFactory().createSection(parent, "UPCA", false, 2);
	...
	protected void initializeProvidedProperties() {
		...
		addProvidedProperties(UPCAComponent.PROPERTY_CHECKSUM_MODE, Messages.common_checksum_mode);
