 ...
 *******************************************************************************/
package com.jaspersoft.studio.components.crosstab.model.header.action;
...
public class CreateCrosstabHeaderAction extends ACreateAction {
	 ...
	 */
	public CreateCrosstabHeaderAction(IWorkbenchPart part) {
		super(part);
		setCreationFactory(new JDPaletteCreationFactory(MCrosstabHeaderCell.class));
	}
