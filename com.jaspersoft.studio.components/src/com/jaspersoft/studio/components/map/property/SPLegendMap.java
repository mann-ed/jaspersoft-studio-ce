...
public class SPLegendMap extends ASPropertyWidget<LegendPropertyDescriptor> {
	...
	protected void createComponent(Composite parent) {
		...
		editBtn.setText("...");
		editBtn.setToolTipText("Edit Map Legend settings");
		...
		delBtn.setToolTipText("Remove Map Legend settings");
		delBtn.setLayoutData(new GridData(SWT.FILL,SWT.FILL,false,false));
		delBtn.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				boolean reply = MessageDialog.openQuestion(UIUtils.getShell(), "Map Legend", "Do you want to remove the settings?");
				if(reply) {
