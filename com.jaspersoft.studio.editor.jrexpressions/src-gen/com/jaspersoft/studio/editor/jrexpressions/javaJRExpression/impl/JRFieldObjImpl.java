...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JR Field Obj</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.jaspersoft.studio.editor.jrexpressions.javaJRExpression.impl.JRFieldObjImpl#getBracedIdentifier <em>Braced Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JRFieldObjImpl extends JasperReportsExpressionImpl implements JRFieldObj
{
  /**
  ...
  {
    return JavaJRExpressionPackage.Literals.JR_FIELD_OBJ;
  }
  ...
  public void setBracedIdentifier(String newBracedIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaJRExpressionPackage.JR_FIELD_OBJ__BRACED_IDENTIFIER, oldBracedIdentifier, bracedIdentifier));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JavaJRExpressionPackage.JR_FIELD_OBJ__BRACED_IDENTIFIER:
