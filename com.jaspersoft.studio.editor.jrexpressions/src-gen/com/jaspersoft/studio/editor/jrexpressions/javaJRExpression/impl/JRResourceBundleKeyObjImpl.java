...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JR Resource Bundle Key Obj</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.jaspersoft.studio.editor.jrexpressions.javaJRExpression.impl.JRResourceBundleKeyObjImpl#getBracedIdentifier <em>Braced Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JRResourceBundleKeyObjImpl extends JasperReportsExpressionImpl implements JRResourceBundleKeyObj
{
  /**
   ...
   * @generated
   */
  protected JRResourceBundleKeyObjImpl()
  {
    super();
  }
  ...
  {
    return JavaJRExpressionPackage.Literals.JR_RESOURCE_BUNDLE_KEY_OBJ;
  }
  ...
  public void setBracedIdentifier(String newBracedIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaJRExpressionPackage.JR_RESOURCE_BUNDLE_KEY_OBJ__BRACED_IDENTIFIER, oldBracedIdentifier, bracedIdentifier));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JavaJRExpressionPackage.JR_RESOURCE_BUNDLE_KEY_OBJ__BRACED_IDENTIFIER:
