...
public class JobMailNotification implements java.io.Serializable {
	...
	public JobMailNotification(long id, int version, java.lang.String[] toAddresses, java.lang.String subject,
			java.lang.String messageText,
			com.jaspersoft.ireport.jasperserver.ws.scheduler.ResultSendType resultSendType, boolean skipEmptyReports) {
		this.id = id;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.id == other.getId() && this.version == other.getVersion()
				&& ((this.toAddresses == null && other.getToAddresses() == null) || (this.toAddresses != null
				...
				&& ((this.messageText == null && other.getMessageText() == null)
						|| (this.messageText != null && this.messageText.equals(other.getMessageText())))
				&& ((this.resultSendType == null && other.getResultSendType() == null)
						|| (this.resultSendType != null && this.resultSendType.equals(other.getResultSendType())))
	...
	public synchronized int hashCode() {
		...
		if (getToAddresses() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getToAddresses()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			JobMailNotification.class, true);

	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://www.jasperforge.org/jasperserver/ws", "JobMailNotification"));
		...
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://www.jasperforge.org/jasperserver/ws", "ResultSendType"));
		elemField.setNillable(true);
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
