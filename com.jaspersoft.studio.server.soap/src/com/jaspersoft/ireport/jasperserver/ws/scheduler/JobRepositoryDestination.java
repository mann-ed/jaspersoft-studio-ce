...
public class JobRepositoryDestination implements java.io.Serializable {
	...
	public JobRepositoryDestination(long id, int version, java.lang.String folderURI, boolean sequentialFilenames,
			boolean overwriteFiles, java.lang.String outputDescription, java.lang.String timestampPattern) {
		this.id = id;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true && this.id == other.getId() && this.version == other.getVersion()
				&& ((this.folderURI == null && other.getFolderURI() == null)
						|| (this.folderURI != null && this.folderURI.equals(other.getFolderURI())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			JobRepositoryDestination.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.jasperforge.org/jasperserver/ws",
