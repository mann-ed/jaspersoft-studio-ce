...
public class WSUserSearchCriteria  implements java.io.Serializable {
    ...
    private com.jaspersoft.ireport.jasperserver.ws.WSRole[] requiredRoles;
    ...
    public WSUserSearchCriteria(
           ...
           com.jaspersoft.ireport.jasperserver.ws.WSRole[] requiredRoles,
           int maxRecords) {
           this.name = name;
     ...
     */
    public com.jaspersoft.ireport.jasperserver.ws.WSRole[] getRequiredRoles() {
        return requiredRoles;
    }
     ...
     * @param requiredRoles
     */
    public void setRequiredRoles(com.jaspersoft.ireport.jasperserver.ws.WSRole[] requiredRoles) {
        this.requiredRoles = requiredRoles;
    }
