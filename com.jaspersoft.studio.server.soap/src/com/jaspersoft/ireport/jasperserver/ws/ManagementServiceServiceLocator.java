...
public class ManagementServiceServiceLocator extends
		org.apache.axis.client.Service implements
		com.jaspersoft.ireport.jasperserver.ws.ManagementServiceService {

	private static final long serialVersionUID = 8148028359770220889L;
	...
	public ManagementServiceServiceLocator(java.lang.String wsdlLoc,
	...
	public com.jaspersoft.ireport.jasperserver.ws.ManagementService getrepository()
			throws javax.xml.rpc.ServiceException {
	...
	public com.jaspersoft.ireport.jasperserver.ws.ManagementService getrepository(
		...
		try {
			com.jaspersoft.ireport.jasperserver.ws.RepositorySoapBindingStub _stub = new com.jaspersoft.ireport.jasperserver.ws.RepositorySoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (com.jaspersoft.ireport.jasperserver.ws.ManagementService.class
					.isAssignableFrom(serviceEndpointInterface)) {
				com.jaspersoft.ireport.jasperserver.ws.RepositorySoapBindingStub _stub = new com.jaspersoft.ireport.jasperserver.ws.RepositorySoapBindingStub(
						new java.net.URL(repository_address), this);
				_stub.setPortName(getrepositoryWSDDServiceName());
				return _stub;
			}
