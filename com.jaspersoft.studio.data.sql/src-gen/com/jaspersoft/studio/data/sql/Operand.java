 ...
 *   <li>{@link com.jaspersoft.studio.data.sql.Operand#getFext <em>Fext</em>}</li>
...
public interface Operand extends EObject
{
   ...
   * @see com.jaspersoft.studio.data.sql.SqlPackage#getOperand_Fext()
   * @model containment="true"
   * @generated
   */
  FunctionExtract getFext();

  /**
   * Sets the value of the '{@link com.jaspersoft.studio.data.sql.Operand#getFext <em>Fext</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Fext</em>' containment reference.
   * @see #getFext()
   * @generated
   */
  void setFext(FunctionExtract value);
