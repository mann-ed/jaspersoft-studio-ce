...
public class ResourcePublisher extends com.jaspersoft.studio.messages.ResourcePublisher{
	...
	public String getPluginName() {
		return "com.jaspersoft.studio.doc";
	}
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
												 "com.jaspersoft.studio.doc.messages", 
												 "messages.properties", 
												 "In this file there are the standard strings used by the documentation plugin",
												 getClassLoader(),
												 "com/jaspersoft/studio/doc/messages/messages.properties", this));
