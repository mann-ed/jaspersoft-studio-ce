...
/**
 * This StringMatcher class is the exact code by the Eclipse one.
 * <p> 
 * We are using this in the effort of addressing "bad" internal usages 
 * we had of no-longer existing StringMatcher classes and for keeping the 
 * back-compatibility with older Eclipse versions which do not have the latest version.
 * </p>
 *
 * @author Massimo Rabbi (mrabbi@users.sourceforge.net)
 * @see org.eclipse.core.text.StringMatcher
 */
