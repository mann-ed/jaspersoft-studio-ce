...
public class ResourcePublisher extends com.jaspersoft.studio.messages.ResourcePublisher{
	...
	public String getPluginName() {
		return "com.jaspersoft.studio.doc.samples";
	}
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
												 "com.jaspersoft.studio.doc.samples.messages", 
												 "messages.properties", 
												 "In this file there are the strings used by the wizard to import the samples",
												 getClassLoader(),
												 "com/jaspersoft/studio/doc/samples/messages/messages.properties", this));
